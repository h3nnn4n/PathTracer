...
Sphere spheres[] = {
    Sphere(1e5 , Vector(50, 1e5, 81.6),             Color(.0, .0, .0), Color(.99, .99, .99),    0.0), // Floor
    Sphere(16.5, Vector(27, 16.5, 47),              Color(.0, .0, .0), Color(.00 ,.75, .99),    1.0), // Mirror ball
    Sphere(16.5, Vector(73, 16.5, 78),              Color(.0, .0, .0), Color(.15, .15, .75),    0.0), // Difuse ball front
    Sphere(16.5, Vector(113,16.5,-10),              Color(.0, .0, .0), Color(.95, .0,   .0),    0.0), // Difuse ball behind

    Sphere(16.5 + 80, Vector(133, 16.5 + 80, -100), Color(.0, .0, .0), Color(.99, .99, .99),    1.0), // Big mirror ball
